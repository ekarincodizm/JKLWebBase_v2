...
namespace JKLWebBase_v2.Reports.Leasings.Leasing_KH2
{
    public partial class Car_Leasing_KH21 : Page
    {
        ...
        public void ExportReport(Car_Leasing_KH2 rpt)
        {
            ...
            process.StartInfo.FileName = "C:/ReportExport/" + mainDirectory + "/สัญญา_ข_2_" + cls.Deps_no + ".pdf";
            process.Start();
        }
    }
}