...
{
    public partial class Notification_Payment_Export : Page
    {
        ...
        public void ExportReport_Mod_I(Notification_Payment rpt)
        {
            ...
            string mainDirectory = "Notification_Payment";
            ...
            string FilePath = "C:/ReportExport/" + mainDirectory + "/รายงานแจ้งเตือนค่างวด_" + DateTimeUtility._dateToFile() + ".pdf";
            ...
            /// Export Report to PDF File with Save As Mode
            rpt.ExportToDisk(ExportFormatType.PortableDocFormat, @"C:/ReportExport/" + mainDirectory + "/รายงานแจ้งเตือนค่างวด_" + DateTimeUtility._dateToFile() + ".pdf");
