...
{
    public partial class Car_Leasing_KH11 : Page
    {
        ...
        private void _loadReport()
        {
            ...
            try
            {
                ...
                Car_Leasing_KH1 rpt = new Car_Leasing_KH1();
                rpt.SetDataSource(ls_ds);

                CRV_Display_Report.ReportSource = rpt;

                /// Export Report to PDF File with Save As Mode
                /// rpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "สัญญา_ข_1_" + cls.Deps_no);
                /// Response.End();
        ...
        public void ExportReport(Car_Leasing_KH1 rpt)
        {
            cls = (Car_Leasings)Session["Leasings"];
            ...
            string FilePath = "C:/ReportExport/" + mainDirectory + "/สัญญา_ข_1_" + cls.Deps_no + ".pdf";
            ...
            /// Export Report to PDF File with Save As Mode
            rpt.ExportToDisk(ExportFormatType.PortableDocFormat, @"C:/ReportExport/" + mainDirectory + "/สัญญา_ข_1_" + cls.Deps_no + ".pdf");
