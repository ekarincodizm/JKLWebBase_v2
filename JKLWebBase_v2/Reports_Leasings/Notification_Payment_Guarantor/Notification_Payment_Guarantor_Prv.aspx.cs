...
namespace JKLWebBase_v2.Reports_Leasings.Notification_Payment_Guarantor
{
    public partial class Notification_Payment_Guarantor_Prv : Page
    {
        ...
        protected void Search_Btn_Click(object sender, EventArgs e)
        {
            ...
            List<Car_Leasings> list_cls = cls_mng.getReportGeneralLeasing(deposit_no, leasing_no, idcard, fname, lname, date_str, date_end, leasing_Code_inline, Company_id_inline, zone_id_inline, lost_str, lost_end, district, province, 0, 0);
            ...
            Session["date_str_rpt"] = date_str;
            Session["date_end_rpt"] = date_end;
            Session["lost_str_rpt"] = lost_str;
            Session["lost_end_rpt"] = lost_end;
            Session["district_rpt"] = district;
            Session["province_rpt"] = province;
            ...
            Export_Reported_Btn.Visible = true;
        }
        ...
        protected void Export_Reported_Btn_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "script", "<script type = 'text/javascript'> window.open('/Reports_Leasings/Notification_Payment/Notification_Payment_Export'); </script>");
        }
