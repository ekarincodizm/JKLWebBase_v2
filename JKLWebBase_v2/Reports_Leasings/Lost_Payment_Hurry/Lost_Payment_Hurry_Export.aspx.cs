...
{
    public partial class Lost_Payment_Hurry_Export : Page
    {
        ...
        public void ExportReport_Mod_I(Lost_Payment_Hurry rpt)
        {
            ...
            string mainDirectory = "Lost_Payment_Hurry";
            ...
            string FilePath = "C:/ReportExport/" + mainDirectory + "/รายงานลูกค้าขาดชำระค่างวด (เร่งรัด)_" + DateTimeUtility._dateToFile() + ".pdf";
            ...
            /// Export Report to PDF File with Save As Mode
            rpt.ExportToDisk(ExportFormatType.PortableDocFormat, @"C:/ReportExport/" + mainDirectory + "/รายงานลูกค้าขาดชำระค่างวด (เร่งรัด)_" + DateTimeUtility._dateToFile() + ".pdf");
