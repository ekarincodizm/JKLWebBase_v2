...
namespace JKLWebBase_v2.Reports_Leasings.Lost_Payment_Hurry
{
    public partial class Lost_Payment_Hurry_Prv : Page
    {
        ...
        protected void Export_Reported_Btn_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "script", "<script type = 'text/javascript'> window.open('/Reports_Leasings/Lost_Payment_Hurry/Lost_Payment_Hurry_Export'); </script>");
        }
