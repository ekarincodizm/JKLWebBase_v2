namespace JKLWebBase_v2.Class_Leasings
{
    public class Car_Leasings_Photo
    {
        ...
        public string Car_img_full_path { get; set; } /// ที่เก็บไฟล์รูปภาพ
        public string Car_img_local_path { get; set; } /// ที่เก็บไฟล์รูปภาพ
        public string Car_img_save_date { get; set; } /// วันที่บันทึก
