<%@ Page Title="ผู้ค้ำประกัน" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Leasing_Add_Bondsman.aspx.cs" Inherits="JKLWebBase_v2.Form_Leasings.Leasing_Add_Bondsman" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-lg-12">
        <h4 class="page-header">เพิ่มข้อมูลผู้ค้ำประกันคนที่
            <asp:Label ID="Number_Of_Bondsman" runat="server"></asp:Label>
        </h4>
    </div>
                    ...
                    <div class="row col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <asp:LinkButton ID="Home_Copy_Idcard_btn" runat="server" CssClass="btn btn-sm btn-success" OnClick="Home_Copy_Idcard_btn_Click"><i class="fa fa-copy fa-fw"></i> ตามบัตรประชาชน </asp:LinkButton>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="form-group col-xs-1">
