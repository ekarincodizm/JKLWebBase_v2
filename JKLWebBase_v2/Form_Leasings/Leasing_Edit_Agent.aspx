<%@ Page Title="แก้ไขข้อมูลนายหน้า" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Leasing_Edit_Agent.aspx.cs" Inherits="JKLWebBase_v2.Form_Leasings.Leasing_Edit_Agent" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            ...
                            <div class="form-group input-group">
                                <asp:TextBox ID="Agent_commission_TBx" runat="server" CssClass="form-control" ></asp:TextBox>
                        ...
                        <div class="col-xs-2">
                            ...
                            <div class="form-group input-group">
                                <asp:TextBox ID="Agent_percen_TBx" runat="server" CssClass="form-control" OnTextChanged="Agent_percen_TBx_TextChanged" AutoPostBack="true"></asp:TextBox>
