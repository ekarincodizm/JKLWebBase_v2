...
{
    public partial class Leasing_Edit_Dealer : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Dealers_Values clr_val = (Dealers_Values)Session["Dealers_Leasing"];

                _GetDealer(clr_val.dlr);
                _GetDealerValue(clr_val);
            }
        ...
        *******************************************************************************************************************************************************************************/
        ...
        private void _GetDealerValue(Dealers_Values dlr_val)
        {
            Dealer_commission_TBx.Text = dlr_val.Dealer_commission.ToString("#,###.00");
            Dealer_percen_TBx.Text = dlr_val.Dealer_percen.ToString("#,###.00");
            Dealer_cash_TBx.Text = dlr_val.Dealer_cash.ToString("#,###.00");
            Dealer_net_com_TBx.Text = dlr_val.Dealer_net_com.ToString("#,###.00");
            Dealer_com_code_TBx.Text = dlr_val.Dealer_com_code;
            Dealer_bookcode_TBx.Text = dlr_val.Dealer_bookcode;
            Dealer_date_print_TBx.Text = DateTimeUtility.convertDateToPage(dlr_val.Dealer_value_save_date);
        }
        ...
        *******************************************************************************************************************************************************************************/
        ...
        private void _AddDealer_Value(string Dealer_id, string Leasing_id)
        {
            ...
            cdl_mng.removeDealer(Leasing_id);
