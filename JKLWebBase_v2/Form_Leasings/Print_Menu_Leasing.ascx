        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-md-3">
                        <asp:HyperLink ID="Print_Payment_Schedule" runat="server" Target="_blank" CssClass="btn btn-sm btn-primary" NavigateUrl="/Reports/Leasings/Payment_Schedule/Payment_Schedule_Prv?mod=1"> <i class="fa fa-print fa-fw"></i> พิมพ์ตารางการผ่อนชำระ (แม่แบบ) </asp:HyperLink>
                    </div>
                    <div class="col-md-3">
                        <asp:HyperLink ID="Print_Full_Payment_Schedule" runat="server" Target="_blank" CssClass="btn btn-sm btn-primary" NavigateUrl="/Reports/Leasings/Payment_Schedule/Payment_Schedule_Prv?mod=2"> <i class="fa fa-print fa-fw"></i> พิมพ์ตารางการผ่อนชำระ (เต็ม) </asp:HyperLink>
                    </div>
                    <div class="col-md-3">
                        <asp:HyperLink ID="Print_P_NG_D_3" runat="server" Target="_blank" CssClass="btn btn-sm btn-warning" NavigateUrl="/Reports/Leasings/Withholding_Tax/Withholding_Tax_Prv"> <i class="fa fa-print fa-fw"></i> พิมพ์ใบหัก ณ ที่จ่าย </asp:HyperLink>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group col-md-3">
                        <asp:HyperLink ID="Print_Half_Certified" runat="server" Target="_blank" CssClass="btn btn-sm btn-info" NavigateUrl="/Reports/Leasings/Certified_Leasing/Certified_Leasing_Result_Prv"> <i class="fa fa-print fa-fw"></i> พิมพ์หนังสือรับรองการเช่า - ซื้อ</asp:HyperLink>
                    </div>
                    <div class="col-md-3">
