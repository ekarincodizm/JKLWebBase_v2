<%@ Page Title="แก้ไขข้อมูลนายหน้า" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Agents_Edit.aspx.cs" Inherits="JKLWebBase_v2.Form_Agents.Agents_Edit" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-group col-xs-2">
                            <asp:Label ID="Agent_idcard_Lbl" runat="server" >เลขบัตรประชาชน <asp:RequiredFieldValidator ID="RFV_Agent_idcard_TBx" runat="server" ErrorMessage=" กรุณากรอกข้อมูล " CssClass="text-danger" ControlToValidate="Agent_idcard_TBx" SetFocusOnError="true" ValidationGroup="Save_Validation"></asp:RequiredFieldValidator> </asp:Label>
                        ...
                        <div class="col-xs-2">
                            <asp:Label ID="Agent_fname_Lbl" runat="server" >ชื่อ <asp:RequiredFieldValidator ID="RFV_Agent_fname_TBx" runat="server" ErrorMessage=" กรุณากรอกข้อมูล " CssClass="text-danger" ControlToValidate="Agent_fname_TBx" SetFocusOnError="true" ValidationGroup="Save_Validation"></asp:RequiredFieldValidator> </asp:Label>
                            <asp:TextBox ID="Agent_fname_TBx" runat="server" CssClass="form-control" ></asp:TextBox>
                        </div>
                        <div class="col-xs-2">
                            <asp:Label ID="Agent_lname_Lbl" runat="server" >นามสกุล <asp:RequiredFieldValidator ID="RFV_Agent_lname_TBx" runat="server" ErrorMessage=" กรุณากรอกข้อมูล " CssClass="text-danger" ControlToValidate="Agent_lname_TBx" SetFocusOnError="true" ValidationGroup="Save_Validation"></asp:RequiredFieldValidator> </asp:Label>
