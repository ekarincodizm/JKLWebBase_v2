...
namespace JKLWebBase_v2.Managers_Leasings
{
    public class Car_Leasings_Manager
    {
        ...
        public Car_Leasings getCarLeasingById(string Leasing_id)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    cls.cls_plate_pv.Province_id = reader.IsDBNull(33) ? defaultNum : reader.GetInt32(33);
                    ...
                    cls.cls_owner_pv.Province_id = reader.IsDBNull(63) ? defaultNum : reader.GetInt32(63);
        ...
        public List<Car_Leasings_Payment> getPaymentScheduleById(string Leasing_id)
        {
            ...
            {
                error = "MysqlException ==> Managers_Leasings --> Car_Leasings_Manager --> getPaymentSchedule() ";
                Log_Error._writeErrorFile(error, ex);
                return null;
            }
            catch (Exception ex)
            {
                error = "Exception ==> Managers_Leasings --> Car_Leasings_Manager --> getPaymentSchedule() ";
                Log_Error._writeErrorFile(error, ex);
                return null;
            }
            finally
        ...
        public bool addCarLeasings(Car_Leasings cls)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@i_Car_plate_province", cls.cls_plate_pv.Province_id);
                ...
                cmd.Parameters.AddWithValue("@i_Car_old_owner_province_id", cls.cls_owner_pv.Province_id);
