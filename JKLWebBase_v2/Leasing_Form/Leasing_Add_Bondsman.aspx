...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="nav nav-tabs">
      <li role="presentation" ><asp:LinkButton ID="link_Leasing_Add" runat="server" OnClick="link_Leasing_Add_Click" ><i class="fa fa-book fa-fw"></i> ข้อมูลสัญญา </asp:LinkButton></li>
      <li role="presentation" class="active"><asp:LinkButton ID="link_Add_Bondsman_1" runat="server" OnClick="link_Add_Bondsman_1_Click" ><i class="fa fa-group fa-fw"></i> ผู้ค้ำประกัน 1</asp:LinkButton></li>
